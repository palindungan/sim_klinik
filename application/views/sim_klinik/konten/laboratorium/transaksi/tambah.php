...
<script type="text/javascript">
	$('.itemName').select2({
		ajax: {
			url: "<?= base_url('laboratorium/transaksi/tampil_select') ?>",
			dataType: "json",
			delay: 250,
...
<?php $this->view('sim_klinik/konten/laboratorium/transaksi/load_php/load_all_detail.php') ?>
...
<script>
	...
	function update_grand_total() {
		...
		$('#grand_total').val(sub_total_lab_tindakan_v);
