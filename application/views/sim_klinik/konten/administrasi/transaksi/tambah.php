...
<script>
    ...
    function search_proses_kamar() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'administrasi/transaksi/tampil_daftar_kamar'; ?>",
    ...
    function update_sub_harga_kamar() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'administrasi/transaksi/ambil_sub_total_kamar'; ?>",
            method: "POST",
            data: form_data,
    ...
    function search_proses_tindakan() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'administrasi/transaksi/tampil_daftar_tindakan'; ?>",
            success: function(hasil) {
    ...
    function update_sub_harga_tindakan() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'administrasi/transaksi/ambil_sub_total_tindakan'; ?>",
            method: "POST",
            data: form_data,
            success: function(data) {
    ...
    function search_proses_obat() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'administrasi/transaksi/tampil_daftar_obat'; ?>",
            success: function(hasil) {
    ...
    function update_sub_harga_obat() {
        ...
        $.ajax({
            url: "<?php echo base_url() . 'administrasi/transaksi/ambil_sub_total_obat'; ?>",
            method: "POST",
            data: form_data,
            success: function(data) {
    ...
    $(document).on('submit', '#transaksi_form', function(event) {
        ...
        // tambah ke database
        $.ajax({
            url: "<?php echo base_url() . 'administrasi/transaksi/input_transaksi_form'; ?>",
            method: "POST",
            data: form_data,
            success: function(data) {
                if (data != "") {
